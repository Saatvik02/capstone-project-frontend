...
const Home = () => {
  return (
    <Box fontFamily="Signika Negative, serif">
      <Box bg="#DEF9C4" color="#1E201E" py={20} mt={20} textAlign="center">
        <Container maxW="container.md">
          ...
          <Button as={Link} to="/explore" mt={6} bg={"#4F6F52"} color="white" _hover={{color:"white", bg:"#1A4D2E"}} size="lg">Start Exploring</Button>
        </Container>
      </Box>

      <Container bg={'#DEF9C4'} color={'black'} borderY={'2px solid black'} maxW="full" py={16} textAlign="center">
        <Heading size="xl" mb={12}>How It Works</Heading>
        <HStack spacing={12} wrap="wrap" justify="center">
          <Box maxW="sm" textAlign="center">
            <Image src="/Images/location.jpg" boxSize="100px" mx="auto" mb={4} borderRadius="50%" />
            <Text fontSize="lg" fontWeight="bold">Select a Region</Text>
            <Text>Enter your location to analyze ragi cultivation.</Text>
          </Box>
          <Box maxW="sm" textAlign="center">
            <Image src="/Images/satellite.jpg" boxSize="100px" mx="auto" mb={4} borderRadius="50%" />
          ...
          <Box maxW="sm" textAlign="center">
            <Image src="/Images/prediction.jpeg" boxSize="100px" mx="auto" mb={4} borderRadius="50%"/>
      ...
      <Box bg="#DEF9C4" color={'black'}  py={16}>
        <Container maxW={'full'} display={'flex'} flexDirection={'column'} textAlign="center">
          ...
          <HStack spacing={10} wrap="wrap" direction={'row'} justify="center">
            <Box maxW="sm" textAlign="center">
            <Image src="/Images/real-time.png" boxSize="120px" mx="auto" mb={4} borderRadius="50%" />
            ...
            <Box maxW="sm" textAlign="center">
            <Image src="/Images/accuracy.png" boxSize="120px" mx="auto" mb={4} borderRadius="50%"/>
            ...
            <Box maxW="sm" textAlign="center">
            <Image src="/Images/user-friendly.jpg" boxSize="120px" mx="auto" mb={4} borderRadius="50%"/>
